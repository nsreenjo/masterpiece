                ...
                <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                        ...
                        <a class="dropdown-item waves-effect" href="#">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-0 small">{{ auth()->user()->user_first_name }}</h6> <!-- Display the logged-in user's name -->
                                    <small class="text-muted">{{ auth()->user()->type }}</small> <!-- If you have user role -->
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <div class="d-grid px-4 pt-2 pb-1">
                            <a class="btn btn-danger d-flex waves-effect waves-light" href="javascript:void(0);">
